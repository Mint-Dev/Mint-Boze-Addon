...
public class SlotUtils {
    ...
    private static int creativeInventory(int i) {
        CreativeInventoryScreen screen = (CreativeInventoryScreen) mc.currentScreen;
        if (!(mc.currentScreen instanceof CreativeInventoryScreen) || !screen.isInventoryTabSelected()) return -1;
